...
TEMPLATE = app
TRANSLATIONS = resources/translations/readesm_de.ts resources/translations/readesm_es.ts resources/translations/readesm_hu.ts resources/translations/readesm_ru.ts resources/translations/readesm_pl.ts
