...
QString SvgDayVelocity::toString() const {
	return addSvgHull(drawVelocityDescription() + "<g transform='scale(0.0083333,-1) translate(0,-100)'><path style='stroke:#D20' d='M 0 0 L " + collected + "'/></g>" + drawBorderAndTimeAxis(), 800);
}
