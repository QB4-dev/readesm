...
int main(int argc, char** argv) {
	...
	if (!gui) {
		...
		if (parser.get("format") == QLatin1String("html") || extension == QLatin1String("html") || extension == QLatin1String("htm") || extension == QLatin1String("xhtml")) {
			HtmlReporter rep;
			rep << esm;
		...
		if (parser.argumentCount() == 1) {
			widgetMainWindow.openFile(parser.getArgument(0));
		}
		return app.exec();
	} else {
